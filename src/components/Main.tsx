    ...
    <div className='flex flex-col w-full gap-12'>
      <div className='flex flex-col md:flex-row gap-28 p-10'>
        <div className='w-full flex flex-col gap-5'>
          <h1 className='text-start font-bold text-4xl dark:text-darkHline'>NearVet</h1>
          <h2 className='text-xl text-lightText dark:text-darkHline'>Encuentra la mejor veterinaria para tu mascota</h2>
          ...
          <div className='flex justify-end gap-5'>
            <button className='rounded-lg text-white bg-detail p-3 shadow-md hover:scale-105'> Encuentra una Clínica</button>
            <button className='rounded-lg bg-secondary p-3 shadow-md hover:scale-105'> Descubre más</button>
          </div>
        </div>
        <div className='lg:w-3/5'>
          <img className='w-full rounded-md' src='https://res.cloudinary.com/dvj0ded3x/image/upload/v1724516607/e-8_shgqns.png' alt='' />
        </div>
      </div>
      <div className='flex flex-col gap-5 bg-secondary dark:bg-darkBG p-10 rounded-md'>
        <span className='text-detail w-full text-center font-extrabold text-lg dark:text-darkHline'>Nuestros Servicios</span>
        <h1 className='text-center font-bold text-4xl'>¡Conectándote con las mejores veterinarias!</h1>
        <p className='text-justify text-xl'>
            ...
            <div className='flex flex-col justify-center h-full'>
              <ul className='flex flex-col gap-10 text-start text-lg'>
                ...
                <li>
                  ...
                  <p>Accede a una ampli agama de servicios veterinarios para las necesidades de tu mascota.</p>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className='flex flex-col gap-5 p-10 rounded-md'>
        ventana de stripe
        <StripePage />
        <span className='text-detail max-w-sm text-center mx-auto p-2 rounded-lg text-lg bg-secondary'>Clínicas Asociadas</span>
        <h1 className='text-center font-bold text-4xl'>Las mejores veterinarias cerca de tí</h1>
        <p className='text-justify text-xl'>
